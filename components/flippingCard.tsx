...
export const FlippingCard = () => {
    ...
    return (
        <div 
            className='perspective-[1000px] cursor-pointer selection:bg-white selection:text-sky-900 w-108 h-73 max-sm:w-80 max-sm:h-56'
            onClick={handleFlip}
                    ...
                    >
                        <Card>
                            <CardContainer variant='default'>
                                ...
                                <DashOutline className="text-sky-50 opacity-80 pointer-events-none" />
                                <CardLogo>
                                    <LogoFront />
                                </CardLogo>
                                <CardBody>
                                    <div className='flex justify-between items-end font-mono tracking-wide text-sm mt-4 max-sm:text-xs max-sm:mt-2'>
                                        ...
                                        <CardContact>
                                            <Link 
                                                href="https://mail.google.com/mail/?view=cm&fs=1&to=ananyavhedge2001@gmail.com"
                                                target="_blank"
                                                rel="noopener noreferrer"
